...
def generate_launch_description():
    ...
    cloud_topic_arg = DeclareLaunchArgument('cloud_topic', default_value='/livox/lidar')
    parameter_filename_arg = DeclareLaunchArgument('parameter_filename', default_value='param_custom.lua')
    parameter_folder_path_arg = DeclareLaunchArgument('parameter_folder_path', default_value=open3d_slam_ros_path + '/param/')
    num_accumulated_range_data_arg = DeclareLaunchArgument('num_accumulated_range_data', default_value='4')
